...
namespace Todo.Tests
{
    ...
    public class TestTodoListBuilder
    {
        ...
        private readonly List<(string title, int rank, Importance importance)> items = new();
        ...
        public TestTodoListBuilder WithItem(string itemTitle, int itemRank, Importance importance)
        {
            items.Add((itemTitle, itemRank, importance));
            return this;
        }
        ...
        public TodoList Build()
        {
            ...
            var todoItems = items.Select(itm => new TodoItem(todoList.TodoListId, owner.Id, itm.title, itm.rank, itm.importance));
